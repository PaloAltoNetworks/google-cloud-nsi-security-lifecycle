...
variable "mgmt_network_name" {
  description = "Name of existing management VPC."
  type        = string
}

variable "data_network_name" {
  description = "Name of existing dataplane VPC."
  type        = string
}

variable "existing_intercept_deployment_group_id" {
  description = "The ID or resource link of an existing network security intercept deployment group."
  type        = string
  default     = ""
}

variable "existing_mirroring_deployment_group_id" {
  description = "The ID or resource link of an existing network security mirroring deployment group."
  type        = string
  default     = ""
}

variable "bootstrap_bucket" {
  description = "The name of the GCS bucket used for bootstrapping the VM-Series firewall."
  type        = string
}
